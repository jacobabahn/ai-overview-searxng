...
component. Python 3.11+; SearXNG supplies its own Python runtime in Docker.
...
go in validated `options`; supported fields are listed in `config.py`.
...
Ruff lint/format checks, ty, 58 unit tests, and the browser integration checks
